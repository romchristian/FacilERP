...
import py.com.ideaspymes.facilerp.pesistencia.contabilidad.enums.CondicionVenta;
...
public class FacturaVenta implements Serializable, Auditable {
    ...
    @OneToMany(mappedBy = "facturaVenta", cascade = CascadeType.PERSIST)
    private List<AplicacionPago> pagos;
    ...
    public List<AplicacionPago> getPagos() {
        return pagos;
    }

    public void setPagos(List<AplicacionPago> pagos) {
        this.pagos = pagos;
    }
