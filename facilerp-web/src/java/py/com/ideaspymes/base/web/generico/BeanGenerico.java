...
public abstract class BeanGenerico<T> implements Serializable {
    ...
    public String create() {
        ...
        if (getEjb().create(getActual(),credencial.getUsuario().getUsuario()) != null) {
    ...
    public String edit() {
        if (getEjb().edit(getActual(),credencial.getUsuario().getUsuario()) == null) {
    ...
    public String remove() {
        getEjb().remove(getActual(),credencial.getUsuario().getUsuario());
        setActual(null);
