...
insert into producto(codigo,nombre,tipoproducto,impuesto_id,unidadmedidabase_id,costo,precioventa,inventariable,tienevencimiento,estado)
values ('001','Azucar','MATERIA_PRIMA',1,1,10000,15000,true,true,'ACTIVO');
